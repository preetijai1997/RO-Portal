...
public class BlanceEnquiryPage {
  static WebDriver driver;
	public BlanceEnquiryPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//ul[@role='tablist']/a/li[text()='Balance Enquiry']")
	...
	public void BalanceEnquiryForm(String num, String BankName,String aadhar) throws InterruptedException {
		...
		for (int i = 0; i < listOfNavMenu.size(); i++) {
			...
			if(listOfNavMenu.get(i).getText().equals("Balance Enquiry"))
			{
				Thread.sleep(3000);
