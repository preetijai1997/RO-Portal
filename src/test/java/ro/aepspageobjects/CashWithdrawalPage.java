...
public class CashWithdrawalPage {
	...
	public CashWithdrawalPage(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath = "//ul[@role='tablist']/a/li[text()='Cash Withdrawal ']")
	public WebElement clickOnCashWithdrawal;
	...
	public void CashwithdrawalForm(String num, String BankName,String aadhar, String amount) throws InterruptedException {
		...
		for (int i = 0; i < listOfNavMenu.size(); i++) {
			...
			if(listOfNavMenu.get(i).getText().equals("Cash Withdrawal"))
			{
				Thread.sleep(3000);
